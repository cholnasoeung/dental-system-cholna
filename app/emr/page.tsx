...
export default function EmrPage() {
  ...
  const selectedToothPricing = toothConditionPricing[selectedTooth.condition];
                      ...
                      <div className="rounded-[26px] border border-slate-200 bg-white p-4 shadow-[0_18px_34px_rgba(15,23,42,0.06)]">
                        ...
                        <div className="mt-3 flex items-start justify-between gap-3 xl:block">
                          ...
                          <p className="mt-2 text-xs font-medium uppercase tracking-[0.22em] text-slate-500">
                            Pricing:{" "}
                            {selectedTooth.conditionPrice === null
                              ? "Not billable"
                      ...
                      <div className="rounded-[26px] border border-slate-200 bg-white p-4 shadow-[0_18px_34px_rgba(15,23,42,0.06)]">
                        ...
                        <div className="mt-4 grid gap-4 lg:grid-cols-[220px_minmax(0,1fr)]">
                          ...
                          <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3">
                            <p className="text-sm font-medium text-slate-700">Price Rule</p>
                            <p className="mt-1 text-sm text-slate-600">
                              {selectedToothPricing.defaultPrice === null
                                ? `${selectedToothPricing.label} teeth are not billed by default.`
                                : `${selectedToothPricing.label} uses a default price of $${selectedToothPricing.defaultPrice.toFixed(2)}.`}
                            </p>
                          </div>
                        </div>
